...
Если вы хотите собрать загружаемую по сети и работающую только из памяти сборку Ubuntu - вот тут есть готовый конструктор: [thinclient](https://github.com/selivan/thinclient).
